  ...
  return (
    <Box>
      ...
      <Grid
        container
        sx={{
          padding: { xs: "100px 0 30px 0", lg: "100px 100px 30px 100px" },
      ...
      >
        <Grid
          ...
          xs={12}
          lg={6}
          sx={{ textAlign: "center", padding: { xs: "0 10px", lg: "0 100px" } }}
        >
          <Typography
            variant={"h6"}
          ...
          <Card sx={{ padding: "30px 50px", margin: "50px 0" }}>
            <Typography mb={7} sx={{ fontWeight: "bold", fontSize: "25px" }}>
              Contact Information
            </Typography>
            <Typography my={3} sx={{ display: "flex", textAlign: "left" }}>
              <LocationOnIcon sx={{ color: "black" }} />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <span>
                Soubhagya Nagar, Phase - 2, Unit-VIII, Bhubaneswar, Odisha
              </span>
            </Typography>
            <Typography my={3} sx={{ display: "flex", textAlign: "left" }}>
        ...
        >
          <Card sx={{ padding: "50px 0" }}>
            <Typography mb={6} sx={{ fontWeight: "bold", fontSize: "25px" }}>
              Connect With Us
            </Typography>
            <Box
              component="form"
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <WhatsAppIcon sx={{ fontSize: { xs: "30px", lg: "50px" } }} />
                &nbsp;&nbsp; +91 9090718208
              </Typography>
            </a>
          </Card>
