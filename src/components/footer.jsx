  ...
  return (
    <div style={{ marginTop: "50px" }}>
        ...
        >
          ...
          >
            ...
            <Typography sx={{ fontSize: "12px" }}>
              Moving your card details to a much more secure place.
            </Typography>
          </Card>
        </Grid>
        <Grid
      ...
      >
        <Grid item xs={12} lg={4}>
          <Box
            ...
            sx={{
              width: "200px",
              margin: { xs: "50px 0 10px 0", md: "60px 0 30px 0" },
            }}
          />
          <Box>
            <FacebookIcon
              sx={{ fontSize: "30px", cursor: "pointer", margin: "10px" }}
            />
            <YouTubeIcon
              sx={{ fontSize: "30px", cursor: "pointer", margin: "10px" }}
            />
        ...
        <Grid item xs={12} lg={2} className={"footer"}>
          <Typography
            variant="h6"
            sx={{ fontSize: "16px", margin: { xs: "30px", lg: "40px 0" } }}
          >
            NAVIGATE
          </Typography>
          <li>
        ...
        <Grid item xs={12} lg={3} className={"footer"}>
          ...
          <li>
            <a href="#">Report Abuse and Takedown Policy</a>
          </li>
          <li>
            <a href="#">FAQ</a>
          </li>
        ...
        <Grid item xs={12} lg={3}>
          ...
          >
            <input
              ...
              style={{ padding: matchDownMd ? "10px 10px" : "10px 15px" }}
            />
            <button
              type="submit"
      ...
      <div className="copyright">
        <p>
          © Tanishka Traders 2022. All Rights Reserved | Designed by Aexki Web
          Solutions.
        </p>
      </div>
    </div>
